//
//  WSLTransitionInteractiveThree.m
//  TransferAnimation
//
...
@implementation WSLTransitionInteractiveThree
...
- (void)handleGesture:(UIPanGestureRecognizer *)panGesture{
    ...
    switch (_interactiveType) {
        case WSLInteractiveThreeTypePresent:
            [self doInteractiveTypePresent:panGesture];
            break;
        case WSLInteractiveThreeTypeDissmiss:
            [self doInteractiveTypeDissmiss:panGesture];
            break;
        case WSLInteractiveThreeTypePush:
            [self doInteractiveTypePush:panGesture];
            break;
        case WSLInteractiveThreeTypePop:
